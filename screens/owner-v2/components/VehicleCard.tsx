...
const VehicleCard: React.FC<Props> = ({ vehicle, onEdit, onDelete, onPress }) => {
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.specsContainer}>
          ...
          <View style={styles.specItem}>
            <MaterialCommunityIcons name="scale-balance" size={18} color="#10B981" />
          ...
          {/* Cột 3: Năm SX */}
          <View style={styles.specItem}>
            <MaterialCommunityIcons name="calendar-blank-outline" size={18} color="#10B981" />
