  ...
  return (
    <View style={styles.circleItem}>
        ...
        <View style={[styles.ring, { borderColor: color + '30' }]}>
            ...
            <View style={[styles.ringProgress, { borderColor: color, borderRightColor: 'transparent', transform: [{rotate: '45deg'}] }]} /> 
...
const styles = StyleSheet.create({
  ...
  link: {
    textAlign: 'right', marginTop: 12, fontSize: 12, color: '#3B82F6', fontWeight: '500'
  }
})
